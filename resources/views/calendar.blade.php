@extends('layouts.app')
@section('title', 'Calendar | Studio 3 Dance Plano, TX')
...
@section('content')
    ...
    <x-banner banner="banner-calendar.jpg" alt="girls stretching front split at barre" position="50% 35%" heading="Calendar" />

...
{{--            <img src="{{ asset('/storage/' . $article->newsImage) }}" alt="" class="img-fluid" style="max-width: 400px; width: 100%; height: auto;">--}}
            ...
            @if($article->articleImage)
                <div class="d-flex justify-content-center">
                    <img src="{{ asset('/storage/' . $article->articleImage) }}" class="img-fluid">
                </div>
            @endif
            <p class="my-5">{!! $article->articleContent !!}</p>

            <div class="mont my-1">
                <div style="border: 2px solid #E11B22; width: max-content;" class="rounding shadow px-3 py-2"><a style="color: #E11B22;" class="text-decoration-none" href="/articles">Back to Newsletter</a></div>
            </div>
